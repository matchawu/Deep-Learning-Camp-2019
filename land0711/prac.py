...
feature_num = 119
marker = Sequential()
marker.add(Dense(128, activation='selu', input_shape=(feature_num,)))
marker.add(Dense(64, activation='selu'))
...
res = ranknet.fit([train_x[index_train[:,0]], train_x[index_train[:,1]]], target_train, \
